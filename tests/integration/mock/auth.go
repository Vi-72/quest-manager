...
// Source: quest-manager/internal/adapters/out/client/auth (interfaces: Client)
...
func (m *MockClient) Authenticate(arg0 context.Context, arg1 string) (uuid.UUID, error) {
	m.ctrl.T.Helper()
