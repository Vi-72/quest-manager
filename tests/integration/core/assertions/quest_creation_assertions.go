...
type QuestCreationAssertions struct {
	assert *assert.Assertions
}

func NewQuestCreationAssertions(a *assert.Assertions) *QuestCreationAssertions {
	return &QuestCreationAssertions{assert: a}
}
...
func (a *QuestCreationAssertions) QuestHTTPCreatedSuccessfully(createResp *casesteps.HTTPResponse, err error) servers.Quest {
...
func (a *QuestCreationAssertions) QuestHTTPValidationError(createResp *casesteps.HTTPResponse, err error, expectedField string) {
	a.assert.NoError(err, "HTTP request should not fail")
...
func (a *QuestCreationAssertions) QuestArraysNotNull(httpQuest servers.Quest) {
